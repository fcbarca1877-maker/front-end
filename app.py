...
def train_models():
    ...
    # Preprocessing
    print("Converting match_date to datetime...")
    ...
    model_names = {
        ...
        'Random Forest': RandomForestRegressor(random_state=42, n_estimators=20, max_depth=10, n_jobs=-1),
    ...
    for name, model in model_names.items():
        ...
        print(f"  {name} R2: {models[name]['r2']:.4f}")
